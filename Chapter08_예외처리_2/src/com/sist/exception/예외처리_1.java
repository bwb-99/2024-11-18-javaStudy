 ...
 *                   => 가벼운 에러 => 수정이 가능한 에러
 *                   	예) 
 *                   		FileReader fr=new FileReadr("경로명"/"파일명")
 *                   							       --------------- 수정
 ...
 *                              try
 *                              {
 *                              }catch(ArrayIndexOutOfBoundsException e| NullPointException e)
 *                              {
 *                              }
 *                              
 *                              일반적으로 사용
