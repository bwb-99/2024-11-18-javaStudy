...
public class 변수_2 {
	public static void main(String[] args) {
		...
		long longVal=300000000000L; //long 표현
		/*
		 * 	8byte 메모리 공간을 만들어라
		 * 	=>300000000000 명령
		 * 	=> 사용시에는 longVal
		...
		// 'A' = 65 'a' = 97 , '0' = 48 // 아스키코드
		System.out.println((int)'홍');
		
		boolean boo=false;
		System.out.println(boo);//조건문
		
		float f=10.5f;
		System.out.println(f);
		double d=10.5f;//double 들어가는 순간 double형으로 변환
		// 왼쪽에 있는 데이터형이 항상 크거나 같아서 저장이 가능해진다.
