...
class Util
{
	...
	// 정렬 => ASC/DESC
	// 패키지없는 경우 ==> JSP사용이 안됨, jar파일을 못 만든다
	public void display()
	{
...
//				System.out.print(i+" ");
//			}
		System.out.println("mani에서 display 호출 전 1");
		util.display();
		System.out.println("mani에서 display 호출 완료 5");
		util.display();
		//메소드 호출시에는 메소드는 처음부터 => 끝까지 수행 원래 위치 복구
		
		System.out.println("mani 종료 9");
