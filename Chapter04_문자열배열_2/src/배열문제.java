/*
 * 		배열 => 같은 데이터형을 묶어서 관리(변수 여러개 제어하기 쉽게 한개의 이름이용)
 * 			 -----------
 * 			 용도가 동일
...
public class 배열문제 {
	...
	public static void main(String[] args) {
		...
		//1. (1차배열)1번 학생 100점 2번 학생 90점 3번학생 85점이다. 점수를 score 배열 변수에 저장
//		1) 아래와 같이 출력하시오.
...
//			score[2]=85;
//			
//			total[i]=score[0]+score[1]+score[2];
//		}
//		
//		System.out.printf("1번 학생 : %d점\n2번 학생 : %d점\n3번 학생 : %d점",score[0],score[1],score[2]);
...
//		{
//			if(num[i]<100)
//			System.out.println("사원"+"("+i+")\t"+ num[i]);
//			
//			total+=num[i];
//			avg=total/5;
//		}
//		System.out.println("1월 실적의 총점 :"+total);
//		System.out.println("1월 실적의 평균 :"+avg);
...
//		for(int i=0;i<num.length;i++)
//		{
//			System.out.println("사원("+(i+1)+") "+num[i]);
//			sum+=num[i];//num에 있는 정수를 sum에 누적
//		}
...
//강사님
//		int[] arr=new int[100];// 정수를 100개 저장
//		//초기값 0~9까지
//		for(int i=0;i<arr.length;i++)
//		{
//			arr[i]=(int)(Math.random()*10);
