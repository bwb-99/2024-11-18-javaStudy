...
//		}
//		
//		문제6) 사용자로부터 두개의 정수(시작,끝)를 입력받아 시작(포함)해서 끝(포함)까지의 곱을 출력하는 프로그램을 작성하시오.
...
//		문제9)0~12까지 2의 배수, 3의 배수의 합을 구하여라.
//		int a2=0, a3=0;
//		for(int i=0;i<=12;i++)
//		{
//			if(i%2==0)
...
//				a3+=i;
//		}
//		System.out.println("2의 배수의합:"+a2);
//		System.out.println("3의 배수의합:"+a3);
//	 	문제10)
//		int sum0;
//		for(int i=0;i<=100;i++)
//		{
...
//		문제13) 다음 결과를 출력하는 프로그램 출력예) ********** (5행10열) 
//		Scanner scan=new Scanner(System.in);
