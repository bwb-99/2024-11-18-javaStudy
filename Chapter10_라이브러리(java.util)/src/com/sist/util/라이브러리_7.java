...
public class 라이브러리_7 {
	...
	public static void main(String[] args) {
		...
		//오늘 날짜 읽기
		 ...
		 System.out.println("년도:"+(today.get(Calendar.MONTH)+1));
		 // MONTH => 0 => 저장:-1 , 읽기:+1
		 System.out.println("년도:"+today.get(Calendar.DATE));
		 // week => 1
		 ...
		 System.out.println(today.get((Calendar.MONTH)+1)+"의 마지막날:"+today.getActualMaximum(Calendar.YEAR));
	}
