...
class Student
{
	...
	// 생성자 여러개 사용가능
	Student(int h, String n, String s) //Student(int, String, String)
	{
		hakbun=h;
		name=n;
		sex=s;
...
//		System.out.println("성별:"+sim.hakbun);
//		System.out.println("학번:"+sim.sex);
		...
		Student sim=new Student(2,"심청이","여자");
		System.out.println("이름:"+sim.name);
		System.out.println("성별:"+sim.sex);
		System.out.println("학번:"+sim.hakbun);
		System.out.println();
		
		Student park=new Student(3,"박문수","폴리아모르");
		System.out.println("이름:"+park.name);
		System.out.println("성별:"+park.hakbun);
		System.out.println("학번:"+park.sex);
		System.out.println();
		
		Student lee=new Student(4, "이순신");
		System.out.println("이름:"+lee.name);
		System.out.println("성별:"+lee.hakbun);
		System.out.println("학번:"+lee.sex);
		
		Student kim=new Student("김두한", "남자");
		System.out.println("이름:"+kim.name);
		System.out.println("성별:"+kim.hakbun);
		System.out.println("학번:"+kim.sex);
