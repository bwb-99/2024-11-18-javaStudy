...
public class 연산자_이항연산자_비교연산자1 {
	...
	public static void main(String[] args) {
		...
		System.out.println((int)'/'); //47  ==> 번호를 매기는 것이 유니코드 // C언어 아스키코드
		// 유니코드 => 0~65535
		...
		*/
		...
		//System.out.println(x==y++); //10==9++ 비교 후 false => 10==10  
		System.out.println(x==++y); // 증가후 비교 // 위에 print문이 10==10 => 그대로 증가값이 되어 10==11로 변환
