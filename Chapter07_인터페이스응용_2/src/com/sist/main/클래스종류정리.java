 ...
 *       		| 자바포함 JSP포함      | Jquery, NodeJS, VueJS...
 *       
 *       => 상속
 ...
 *         				}
 *         				-------------------
 *         				*** 인터페이스는 구성요소가 public 이다
 *         					only public
 *         				*** 서로 다른 클래스 여러개 묶어서 한개의 이름으로 제어할 주로 사용
...
public class 클래스종류정리 {
	...
	public static void main(String[] args) {
		...
		{
			System.out.println("obj는 Object이다");
		}
