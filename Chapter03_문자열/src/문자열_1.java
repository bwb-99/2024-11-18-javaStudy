 ...
 *				String replace(String old, String now)
 *			------------------------------------------
...
//		String msg="Hello Java";
//		int len=msg.indexOf("Java"); // 앞에 J를 찾아줘서 출력한다 'java' 일경우 못찾아서 '-1'로 출력
...
//		}
		...
		System.out.println(String.valueOf(a)+String.valueOf(b));//1020 => 문자열로 변경
